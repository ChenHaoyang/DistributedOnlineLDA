...
object DocWordDistCal {
  def main(args: Array[String]) {
    ...
    val docIterator = new OneDocIterator(
      Constants.corpusTableName,
      Constants.corpusFamilyName,
      Constants.DocTopicDistColName
    )
    ...
    lda.docWordDistCal(docIterator)
